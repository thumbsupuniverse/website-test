const contractAddress = "0x3f9F120EB945dD957c72d2BA554C7CAbC60759bc"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the ThumbsUp Universe!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Place Holder.';
const h1_presale_coming_soon = "Universe Portal Coming Soon!!";
...
const button_presale_already_minted = "Join the ThumbsUp Universe.";
